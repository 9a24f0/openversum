...
>
	<g transform="translate(444.10826415830815 228.8524952525583)"
		><path
			id="blob1"
			d="M132.9 -125C193.4 -107.5 278.4 -85.8 325.3 -26.8C372.2 32.3 380.9 128.6 334.5 178C288 227.4 186.2 229.7 96 261.6C5.8 293.5 -72.9 354.9 -120 335.3C-167.1 315.7 -182.7 215.1 -229.7 133C-276.7 50.9 -355 -12.8 -353.4 -69.4C-351.9 -126 -270.4 -175.6 -198.2 -191C-126 -206.5 -63 -187.7 -13.4 -171.7C36.2 -155.8 72.3 -142.5 132.9 -125"
			fill="url(#paint0_linear_1)"
			fill-opacity="0.88"
		/>
	</g>

	<g style="visibility:hidden ;" transform="translate(438.1559418675324 335.0387637713327)">
		<path
			id="blob2"
			d="M218.2 -245C276.9 -210.7 314.7 -136.4 339.8 -51.4C364.9 33.6 377.3 129.3 330.1 171.4C283 213.6 176.2 202.2 101.6 191.1C27 180 -15.3 169.3 -86.7 172C-158 174.7 -258.3 190.9 -304.8 154.5C-351.3 118.2 -344 29.4 -316.2 -43.1C-288.4 -115.7 -240 -172 -183.8 -206.8C-127.7 -241.5 -63.9 -254.8 7.9 -264.2C79.7 -273.7 159.4 -279.3 218.2 -245"
	...
	<defs>
		...
		>
			...
			<stop offset="0.460417" stop-color="#056B41" stop-opacity="0.76" />
			<stop offset="1" stop-color="#AEF9D2" />
		</linearGradient>
	</defs>
</svg>
