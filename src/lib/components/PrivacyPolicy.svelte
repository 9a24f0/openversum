...
<p>
	...
	has been created with the help of the <a
		...
		target="_blank">TermsFeed Privacy Policy Generator</a
	>.
</p>
...
<ul>
	...
	<li>
		<p>
			...
			or &quot;Our&quot; in this Agreement) refers to Openversum, ETH Zürich, HCI E105-Hönggerberg CH,
			Vladimir-Prelog-Weg 1, 8093 ETH, Switzerland.
		</p>
	</li>
	<li>
		<p>
	...
	<li>
		<p>
			<strong>Website</strong> refers to Openversum, accessible from
			<a href="https://openversum.vercel.app/" rel="external nofollow noopener" target="_blank"
				>https://openversum.vercel.app/</a
			>
		</p>
	</li>
	<li>
...
<ul>
	...
	<li>
		...
		for other related website statistics (for example, recording the popularity of a certain section
...
<ul>
	<li>By email: info@openversum.cmo</li>
</ul>
